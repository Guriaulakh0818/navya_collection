    ...
    <div className="mx-auto max-w-6xl px-4 py-14">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="rounded-2xl border border-border bg-white p-6 shadow-premium">
          ...
          <p className="mt-3 text-sm text-slate-600">Navya Collection makes premium, trustworthy fashion accessible to every Indian family.</p>
        </div>
        <div className="rounded-2xl border border-border bg-white p-6 shadow-premium">
          <h2 className="font-heading text-2xl text-navy">Vision</h2>
          <p className="mt-3 text-sm text-slate-600">To become India&apos;s most trusted online fashion destination for gents and kids.</p>
        </div>
      </div>
    </div>
  );
